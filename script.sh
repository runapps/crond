...
find /root -name '${FILE_PREFIX}.${FILE_EXT}.*' -type f | sort -r | tail -n +${tailnum} | xargs -i echo "rm -rf {}"
find /root -name '${FILE_PREFIX}.${FILE_EXT}.*' -type f | sort -r | tail -n +${tailnum} | xargs rm -rf
